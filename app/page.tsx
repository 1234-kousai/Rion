        ...
        <div className="container mx-auto px-4 text-center relative z-10">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="mb-8 animate-fade-in-up">
              <Badge
                variant="outline"
                className="border-purple-400/50 text-purple-300 bg-purple-500/10 backdrop-blur-sm px-8 py-3 text-lg font-medium tracking-widest shadow-lg"
              >
                PROFESSIONAL GUILD
              </Badge>
            </div>

            <h1 className="text-5xl md:text-7xl lg:text-8xl font-black mb-12 leading-tight animate-fade-in-up delay-200 drop-shadow-lg">
            ...
            <p className="text-2xl md:text-3xl text-gray-100 mb-16 leading-relaxed max-w-4xl mx-auto animate-fade-in-up delay-400 tracking-wide">
            ...
            <div className="grid lg:grid-cols-2 gap-8">
              {[
                ...
                <Card
                  ...
                  className={`group border-0 bg-gradient-to-br from-black/50 to-black/70 backdrop-blur-xl hover:from-black/60 hover:to-black/80 transition-all duration-500 hover:scale-105 hover:-translate-y-2 animate-fade-in-up ${item.delay}`}
                >
                  <CardContent className="p-10 pt-16 relative overflow-visible">
                    <div
                    ...
                    <div className="relative z-10">
                      ...
                      <p className="text-lg text-gray-200 mb-8 leading-relaxed">{item.description}</p>
